...
json_filepath = 'basillus_42c120m_edge_data.json'  # Change this to the correct path
output_filepath = 'basillus_42c120m_Edge_processed_with_interaction_Top10.json'  # Change this to the correct path
